package com.flink.apitest.tableapi.udf;
 ...
 * @date 2021/9/19
 */
public class UdfTest3AggregateFunction {
    public static void main(String[] args) throws Exception {
        ...
        // 1. 读取数据
        DataStreamSource<String> inputStream = env.readTextFile(Constant.FILEPATH + "sensor.txt");
